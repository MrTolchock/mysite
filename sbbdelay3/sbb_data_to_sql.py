...
url = "https://data.sbb.ch/api/records/1.0/search/?dataset=actual-data-sbb-previous-day&rows=1000&facet=linien_text&facet=faellt_aus_tf&facet=bpuic&facet=ankunftszeit&facet=an_prognose&facet=an_prognose_status&facet=ab_prognose_status&facet=abfahrtsverspatung&refine.bpuic=8503011&timezone=Europe%2FZurich"
...
for train in js["records"]:
    ...
    cur.execute("INSERT OR IGNORE INTO sbbdelay3_train VALUES (NULL,?,?,?,?,?,?,?,?,?,?,?,?,?)", info)
